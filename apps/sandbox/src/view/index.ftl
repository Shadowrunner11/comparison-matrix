  ...
  <section>
    ...
    <div class="table flex">
      <div class="table__locked-column" data-column="locked">
        <div class="table__cell table__locked-column__header" data-clone="test" data-row="header">
          Escoja el monto
        </div>
        <#list attributes as atribute>
          <div class="table__cell table__locked-column__cell" data-row="${atribute?index}">
            ${atribute}
          </div>
        </#list>
      </div>
      <div class="flex g-1 swiper table__products" data-id="body-columns">
        <div class="swiper-wrapper" data-id="swiper-table-body">
          <#list products as product>
            <div class="swiper-slide" data-column="${product?index}">
              <div 
                class="table__cell table__products__header" 
                data-clone="test" 
                data-row="header"
              >
                ...
                <div class="table__products__header__separation"></div>
                <p>Disponible en:</p>
                <div class="table__products__header__currency-controls">
                  <#if product.isSolesActive>
                    <button data-column="${product?index}" data-currency="soles">
                      <svg 
                        data-currency="soles"
                  ...
                  <#if product.isDollarsActive>
                    <button 
                      data-column="${product?index}"
                      class="${product.isSolesActive?string('color--primary', '')}" 
              ...
              <div class="${product.isSolesActive?string('', 'hidden')}" data-currency-id="soles">
              <#list product.values as value>
                <div class="table__cell" data-row="${value?index}">
                  <#if value.valueSoles?hasContent>
                    ${value.valueSoles}
                  <#else>
                    ${value.valueDollars}
                  </#if>
                ...
                <div class="price table__cell">
                  ${product.priceSoles}
                  <a class="price__cta">${product.cta}</a>
                </div>
                </div>
              <div class="${product.isSolesActive?string('hidden', '')}" data-currency-id="dollars">
              <#list product.values as value>
                <div class="table__cell" data-row="${value?index}">
                  <#if value.valueDollars?hasContent>
                    ${value.valueDollars}
                  <#else>
                    ${value.valueSoles}
                  </#if>
